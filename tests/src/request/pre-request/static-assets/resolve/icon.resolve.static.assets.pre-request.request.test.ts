// tests/src/request/pre-request/static-assets/resolve/icon.resolve.static.assets.pre-request.request.test.ts
...
describe("staticAssetResolverIcon", () => {
  ...
  it("returns null when an allowed icon file has an unsupported extension", async () => {
    ...
    jest.doMock(
      "@request/pre-request/static-assets/config/config.static-assets.pre-request.request",
      () => ({
    ...
    const { staticAssetResolverIcon: isolatedResolver } =
      await import("@request/pre-request/static-assets/resolve/icon.resolve.static.assets.pre-request.request");
