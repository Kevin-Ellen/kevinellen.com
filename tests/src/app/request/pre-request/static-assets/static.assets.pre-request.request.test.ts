// tests/src/app/request/pre-request/static-assets/static.assets.pre-request.request.test.ts
...
jest.mock(
  "@request/pre-request/static-assets/resolve/resolve.static.assets.pre-request.request",
  () => ({
...
jest.mock(
  "@request/pre-request/static-assets/policy/policy.static-assets.pre-request.request",
  () => ({
