// src/app-context/resolve/shell/navigation/footer.navigation.resolve.app-context.ts
...
export const appContextResolveFooterNavigation = (
  ...
  return {
    sections: navigation.sections.map((section) => ({
      ...section,
      items: section.items.map((link) => appContextResolveLink(link, appState)),
    })),
  };
};
