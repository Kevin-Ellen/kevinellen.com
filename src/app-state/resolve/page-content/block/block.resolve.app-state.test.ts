...
jest.mock(
  "@app-state/resolve/page-content/block/homepage-hero.resolve.app-state",
  () => ({
...
jest.mock(
  "@app-state/resolve/page-content/block/image-strip.resolve.app-state",
  () => ({
...
jest.mock(
  "@app-state/resolve/page-content/block/homepage-journal-listing.resolve.app-state",
  () => ({
...
jest.mock(
  "@app-state/resolve/page-content/block/section-links.resolve.app-state",
  () => ({
