// src/request/pre-request/assets/static/config/config.static-assets.pre-request.request.ts

import type { resolveStaticAssetIcon } from "@request/pre-request/assets/static/types/static-assets.pre-request.request.types";
