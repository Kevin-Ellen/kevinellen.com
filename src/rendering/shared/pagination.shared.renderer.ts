...
export const renderPagination = (
  ...
  return [
    `<nav class="m-pagination" aria-label="${escapeAttribute(ariaLabel)}">`,
    `<div class="m-pagination__slot m-pagination__slot--previous">`,
    pagination.previousHref
      ? `<a class="m-pagination__link m-pagination__link--previous" href="${escapeAttribute(pagination.previousHref)}">${escapeHtml(pagination.previousLabel)}</a>`
      : "",
    `</div>`,
    ...
    pagination.nextHref
      ? `<a class="m-pagination__link m-pagination__link--next" href="${escapeAttribute(pagination.nextHref)}">${escapeHtml(pagination.nextLabel)}</a>`
      : "",
    `</div>`,
    `</nav>`,
  ].join("");
